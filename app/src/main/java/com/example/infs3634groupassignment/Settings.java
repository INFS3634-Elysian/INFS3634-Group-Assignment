    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String text2 =  ("JobSecure aims to add value to the wider UNSW community by providing a one-stop-shop solution that prepares them for every step of the recruitment process. Whilst the recruitment process differs across firms and industries in the corporate sector, the scope of JobSecure will ensure complete coverage of all possible stages." +
                        "<br /><br />" +
                        "With all founders of Elysian being UNSW students who have gone through the same process, we truly hope that other UNSW students can benefit from our uniquely tailored application that facilitates learning through well-developed resources, tests and other noteworthy features."
                );
        ...
        team.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                divider.setVisibility(View.VISIBLE);
                String text2 = ("Elysian consists of the following four founders who together, designed and developed the application:" +
                        ...
                        "<br /><br /> If you'd like to contact our team, please visit our official website: elysian.co"
                );
                finalText2.setText(Html.fromHtml(text2));
